...
if("TRUE" STREQUAL "TRUE")
  set(skills_py_SOURCE_PREFIX /home/aif/ssl/americast/src/skills_py)
  set(skills_py_DEVEL_PREFIX /home/aif/ssl/americast/devel)
  ...
  set(skills_py_INSTALL_PREFIX /home/aif/ssl/americast/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'skills_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aif/ssl/americast/src/skills_py/${idir}'.  Ask the maintainer 'mayank <mayank@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${skills_py_dep}_FOUND)
      find_package(${skills_py_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${skills_py_dep} REQUIRED ${depend_list})
  endif()
