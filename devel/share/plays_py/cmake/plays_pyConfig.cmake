...
if("TRUE" STREQUAL "TRUE")
  set(plays_py_SOURCE_PREFIX /home/aif/ssl/americast/src/plays_py)
  set(plays_py_DEVEL_PREFIX /home/aif/ssl/americast/devel)
  set(plays_py_INSTALL_PREFIX "")
  set(plays_py_PREFIX ${plays_py_DEVEL_PREFIX})
else()
  set(plays_py_SOURCE_PREFIX "")
  set(plays_py_DEVEL_PREFIX "")
  set(plays_py_INSTALL_PREFIX /home/aif/ssl/americast/install)
...
if(NOT "/home/aif/ssl/americast/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plays_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aif/ssl/americast/src/plays_py/${idir}'.  Ask the maintainer 'kv <kv@todo.todo>' to fix it.")
    endif()
...
set(plays_py_EXPORTED_TARGETS "plays_py_generate_messages_cpp;plays_py_generate_messages_eus;plays_py_generate_messages_lisp;plays_py_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${plays_py_dep}_FOUND)
      find_package(${plays_py_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${plays_py_dep} REQUIRED ${depend_list})
  endif()
