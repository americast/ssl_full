...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/aif/ssl/americast/src/navigation)
  set(navigation_DEVEL_PREFIX /home/aif/ssl/americast/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/aif/ssl/americast/install)
...
if(NOT "/home/aif/ssl/americast/src/navigation/include " STREQUAL " ")
  set(navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/aif/ssl/americast/src/navigation/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'arpit <arpit@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aif/ssl/americast/src/navigation/${idir}'.  Ask the maintainer 'arpit <arpit@todo.todo>' to fix it.")
    endif()
    _list_append_unique(navigation_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "navigation")
