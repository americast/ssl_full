...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/ss/robocup/src/navigation)
  set(navigation_DEVEL_PREFIX /home/ss/robocup/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/ss/robocup/install)
...
if(NOT "/home/ss/robocup/src/navigation/include " STREQUAL " ")
  set(navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/ss/robocup/src/navigation/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ss/robocup/src/navigation/${idir}'.  Ask the maintainer 'arpit <arpit@todo.todo>' to fix it.")
    endif()
