...
int main(int argc, char *argv[])
{
  ...
  ros::Subscriber bs_sub = n.subscribe("/belief_state", 1000, &RJRobot::beliefStateCallback, &robot);
  ros::Subscriber tp_sub = n.subscribe("/tactic_topic", 1000, &RJRobot::tacticPacketCallback, &robot); // this topic needs to be remapped
  ros::spin();
