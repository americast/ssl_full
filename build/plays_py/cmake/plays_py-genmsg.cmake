...
get_filename_component(_filename "/home/ss/robocup/src/plays_py/srv/role_to_play.srv" NAME_WE)
add_custom_target(_plays_py_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "plays_py" "/home/ss/robocup/src/plays_py/srv/role_to_play.srv" ""
)
...
_generate_srv_cpp(plays_py
  "/home/ss/robocup/src/plays_py/srv/role_to_play.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_nodejs(plays_py
  "/home/ss/robocup/src/plays_py/srv/role_to_play.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/plays_py
)

### Generating Module File
_generate_module_nodejs(plays_py
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/plays_py
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(plays_py_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(plays_py_generate_messages plays_py_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/ss/robocup/src/plays_py/srv/role_to_play.srv" NAME_WE)
add_dependencies(plays_py_generate_messages_nodejs _plays_py_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(plays_py_gennodejs)
add_dependencies(plays_py_gennodejs plays_py_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS plays_py_generate_messages_nodejs)
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/plays_py)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/plays_py
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(plays_py_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
