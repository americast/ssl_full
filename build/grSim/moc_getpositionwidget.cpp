...
#include "../../src/grSim/src/getpositionwidget.h"
...
void GetPositionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        GetPositionWidget *_t = static_cast<GetPositionWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData GetPositionWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GetPositionWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GetPositionWidget,
      qt_meta_data_GetPositionWidget, &staticMetaObjectExtraData }
};
