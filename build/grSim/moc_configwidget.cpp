...
#include "../../src/grSim/src/configwidget.h"
...
const QMetaObjectExtraData ConfigWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ConfigWidget::staticMetaObject = {
    { &VarTreeView::staticMetaObject, qt_meta_stringdata_ConfigWidget,
      qt_meta_data_ConfigWidget, &staticMetaObjectExtraData }
};
...
void ConfigDockWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        ConfigDockWidget *_t = static_cast<ConfigDockWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData ConfigDockWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ConfigDockWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_ConfigDockWidget,
      qt_meta_data_ConfigDockWidget, &staticMetaObjectExtraData }
};
