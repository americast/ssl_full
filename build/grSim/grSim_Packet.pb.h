...
class grSim_Packet : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_commands(::grSim_Commands* commands);
  ...
  inline void set_allocated_replacement(::grSim_Replacement* replacement);
  ...
  inline void set_allocated_debuginfo(::sslDebug_Data* debuginfo);
